...
class CoachModelCatalogueTests(unittest.TestCase):
    ...
    def test_claude_opus_48_is_default(self):
        self.assertEqual(default_coach_model_id(self.settings), "claude-opus-4-8")
    ...
    def test_model_catalogue_follows_fallback_order(self):
        ...
        self.assertEqual(available_coach_models(self.settings)[0].id, "claude-opus-4-8")
